...
class TablaDeSimbolos:
    ...
    def push_mi_alcance(self):
        ...
        while tmp.tabla_padre is not None:
            for cada in tmp.dic_temporales.items():
                self.nuevo_codigo_3d("$s15 = $s15 + 1;")
                self.nuevo_codigo_3d("$s3[$s15] = "+cada[1].contenido+";#push alcance")
            tmp = tmp.tabla_padre
    ...
    def pop_mi_alcance(self):
        ...
        while tmp.tabla_padre is not None:
            for cada in  tmp.dic_temporales.items():
                vol_item=("$s15 = $s15 - 1;",cada[1].contenido+" = $s3[$s15]"+";#pop alcance")
        ...
        for cada in reversed(volcado):
            ...
            self.nuevo_codigo_3d("unset($s3[$s15]);")
    ...
    def mi_tabla_de_retornos(self):
        ...
        self.nuevo_codigo_3d("if ($s15 > 1000) goto stacko;")
        self.nuevo_codigo_3d("if ($sp  > 1000) goto stacko;")
        self.nuevo_codigo_3d("if ($ra  <= 0) goto finprogramaexec;")
        ...
        self.nuevo_codigo_3d("$t1=\"Desbordamiento de pila\";")
        self.nuevo_codigo_3d("print($t1);")
        self.nuevo_codigo_3d("finprogramaexec:")
        self.nuevo_codigo_3d("exit;")
