...
def t_error(t):
    from AProyecto2.Contenido.Analizadores.MinorCSintactico import entrada,list_er
    #print("error lexico ")
    #print([ord(c) for c in str(t.value[0])])
    tp=(find_column(entrada,t))
    from AProyecto2.Contenido.TablaDeSimbolos import Error
    list_er.append(Error("Error Analizando","No se esperaba el token "+str(t.value[0]),2,tp))
